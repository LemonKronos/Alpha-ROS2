...
alpha_brain::OctoMapNode::OctoMapNode(const rclcpp::NodeOptions & options) :
    ...
    fuse_perception_SUB = this->create_subscription<ros2_msgs::msg::FusePerception>(
        ...
        std::bind(&alpha_brain::OctoMapNode::FusePerceptionCallback, this, _1)
    );
...
alpha_brain::OctoMapNode::~OctoMapNode() {
    // Nothing here
}

void alpha_brain::OctoMapNode::FusePerceptionCallback(const ros2_msgs::msg::FusePerception::SharedPtr msg) {
